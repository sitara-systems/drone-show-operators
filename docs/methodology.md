...
1. **Operates its own fleet.** Brokers, resellers, and companies that
   primarily sell drone-show hardware/software to other operators do not
   qualify.
2. **Has flown a meaningful volume of public shows with verifiable
   coverage** — independent news reporting, the operator's own documented
...
Alphabetical only. No ranking, no featured placement, no tiers.

## Corrections &amp; additions

Operators who believe they meet the criteria above, or anyone with a
correction, can reach Sitara Skies via
[skies.sitara.systems/contact](https://skies.sitara.systems/contact/).
Reviewed quarterly alongside the other R-track records.
